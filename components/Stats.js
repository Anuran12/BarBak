        ...
        >
          <div className="w-full justify-start items-center flex flex-col gap-4 mt-8">
            <div className="w-8/12 ml-16 flex bg-gradient-to-r from-[#F7BC06] to-[#ffefbf] px-5 py-1 rounded-2xl items-center">
              <h1 className="text-[#0A0A0A] md:text-[48px] font-semibold break-words">
                {counterOn && (
                  <CountUp start={0} end={90} duration={3} delay={0.5} />
                )}
                %
              </h1>
              <p className=" w-1/2 ml-20 h-fit leading-10 md:text-[32px] text-[#0A0A0A] break-words font-semibold">
                Timely
                <br /> Deliveries
              </p>
            </div>
            <div className="w-8/12 flex bg-gradient-to-r from-[#a7a7a7] to-[#262628] px-5 py-1 rounded-2xl items-center">
              <h1 className="text-[#ffffff] md:text-[48px] font-semibold break-words">
                {counterOn && (
                  <CountUp start={0} end={50} duration={3} delay={0.5} />
                )}
                K+
              </h1>
              <p className=" w-1/2 ml-16 h-fit leading-10 md:text-[32px] text-[#ffffff] break-words font-semibold">
                Orders
                <br /> Processed
              </p>
            </div>
            <div className="w-8/12 ml-16 flex bg-gradient-to-r from-[#F7BC06] to-[#ffefbf] px-5 py-1 rounded-2xl items-center">
              ...
              <p className=" w-1/2 ml-14 h-fit leading-10 md:text-[32px] text-[#0A0A0A] break-words font-semibold">
                Accounts
                <br /> Served
              </p>
            </div>
            <div className="w-8/12 flex bg-gradient-to-r from-[#a7a7a7] to-[#262628] px-5 py-1 rounded-2xl items-center">
              ...
              <p className=" w-1/2 ml-20 h-fit leading-10 md:text-[32px] text-[#ffffff] break-words font-semibold">
                 Recommend
                <br /> BarBak
              </p>
            </div>
