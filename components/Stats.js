    ...
    <div className="mt-[100px] flex flex-row justify-center w-full px-[120px]">
      ...
      <div className="w-full justify-start items-center flex flex-col gap-4 mt-8">
        <div className="w-6/12 ml-16 flex bg-gradient-to-r from-[#F7BC06] to-[#ffefbf] px-5 py-1 rounded-2xl items-center">
          ...
          <p className=" w-1/2 ml-10 h-fit leading-4 text-[16px] text-[#0A0A0A] break-words font-normal">
            Timely Deliveries
          </p>
        </div>
        <div className="w-6/12 flex bg-gradient-to-r from-[#a7a7a7] to-[#262628] px-5 py-1 rounded-2xl items-center">
          ...
          <p className=" w-1/2 ml-7 h-fit leading-4 text-[16px] text-[#ffffff] break-words font-normal">
            Timely Deliveries
          </p>
        </div>
        <div className="w-6/12 ml-16 flex bg-gradient-to-r from-[#F7BC06] to-[#ffefbf] px-5 py-1 rounded-2xl items-center">
          ...
          <p className=" w-1/2 ml-4 h-fit leading-4 text-[16px] text-[#0A0A0A] break-words font-normal">
            Timely Deliveries
          </p>
        </div>
        <div className="w-6/12 flex bg-gradient-to-r from-[#a7a7a7] to-[#262628] px-5 py-1 rounded-2xl items-center">
          ...
          <p className=" w-1/2 ml-10 h-fit leading-4 text-[16px] text-[#ffffff] break-words font-normal">
            Timely Deliveries
          </p>
        </div>
      </div>
