...
export default function Header() {
  ...
  return (
    <div>
          ...
          <nav className="flex gap-10 text-[14px] justify-center items-center">
            ...
            <div class="group relative inline-block">
              <button class="inline-flex items-center rounded px-4 py-">
                <span class="text-white group-hover:text-[#F7BC06]">
                  SERVICE
                </span>
                <svg
      ...
      <div
      className={`fixed bg-[url('../img/bg_black.jpg')] bg-no-repeat bg-center bg-cover h-[100vh] w-[250px] flex flex-col justify-between bg-white z-[999999] duration-300 ${
        menuOpen ? "right-0" : "right-[-250px]"
      }`}
    >
      <div>
        <div className="flex flex-row justify-between p-5">
        <Link href={"/"} className="my-5 scale-75 -ml-10 flex">
          <Image src={Logo1} alt="logo" />
          <Image className="!ml-[-10px]" src={Logo2} alt="logo" />
        </Link>
        ...
        <nav className="flex flex-col text-white/60 gap-10 mt-16 text-[14px] justify-center items-center">
            <Link
              className="hover:text-[#F7BC06] ease-in-out duration-300 pointer"
              href={"/Catalog"}
            >
            ...
            <div class="group relative inline-block">
              <button class="inline-flex items-center rounded px-4 py-">
                <span class="text-white/60 group-hover:text-[#F7BC06]">
                  SERVICE
                </span>
                <svg
                  class="h-4 w-4 fill-current group-hover:fill-[#F7BC06]"
          ...
          <div className="flex gap-3 justify-center items-center col-start-8 mt-10">
