...
export default function Header() {
  ...
  return (
    <div>
      <header
        className={`bg-[url('../img/bg_black.jpg')] bg-no-repeat bg-center bg-cover z-[9999] grid grid-cols-8 px-10 text-white justify-center fixed items-center transition-[top] duration-[0.4s] ease-[ease-out] ${
