        ...
        <div className="lg:w-1/2 w-[90%] md:w-[75%] !bg-white/20 rounded-3xl flex flex-col justify-center lg:p-10 px-5 py-10">
          <form>
            ...
            <button class="bg-yellow-950 text-yellow-400 border border-yellow-400 border-b-4 font-medium overflow-hidden relative rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 px-6 py-3 mt-4 group">
              <span class="bg-yellow-400 absolute -top-[150%] left-0 inline-flex w-80 h-[5px] rounded-md opacity-50 group-hover:top-[150%] duration-500 shadow-[0_0_10px_10px_rgba(0,0,0,0.3)]"></span>
              Send message
            </button>
          </form>
        </div>
