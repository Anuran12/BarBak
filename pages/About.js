	...
	return (
        <div>
            ...
            <div className="mt-[100px] flex flex-col w-full px-[120px]">
                <h1 className="text-[40px] text-center">We create an excellent service<br/> built on values</h1>
                <p className="text-[14px] text-slate-900/60 mt-3 text-center">The quality of our product is very important to us and we take care of our employees to take care of our customers</p>
